  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold font-headline">আমার ব্যয়</h1>
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent className="max-w-[90vw] rounded-2xl">
            <DialogHeader>
              <DialogTitle className="font-headline">নতুন ব্যয় যোগ করুন</DialogTitle>
            </DialogHeader>
            <form onSubmit={handleSubmit} className="space-y-4 pt-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="purpose">উদ্দেশ্য (অপশনাল)</Label>
                <Input 
                  id="purpose" 
      ...
      <div className="space-y-3">
        {expenseTransactions.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-muted-foreground opacity-50 space-y-4">
            ...
            <p className="font-medium">কোন ব্যয়ের রেকর্ড নেই।</p>
          </div>
        )}
      </div>
    </div>
